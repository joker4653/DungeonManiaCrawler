...
public class DungeonManiaController implements Serializable{
    ...
    public DungeonResponse loadGame(String name) throws IllegalArgumentException {
        ...
        setZombAndSpiderSpawnFields(UnSerailizedData, LoadedDMC);
